...
public class RoadMainCitizenFeedbackController
{
    @javafx.fxml.FXML
    private TableView citizenFeedTableView_fxid;
    @javafx.fxml.FXML
    ...
    @javafx.fxml.FXML
    public void View_citezenFeed_OnAction(ActionEvent actionEvent) {
    }
}